...
export function getConfig(code) {
  return fetch({
    url: '/api/basedatasys/bdCustomerConfig/queryByQstCode?qstCode=' + code,
    method: 'get'
  })
}

// 获取关区配置
export function getAgent(code) {
  return fetch({
    url: '/api/basedatasys/bdCustomerAgent/queryByQstCode?qstCode=' + code,
    method: 'get'
  })
}

// 获取回传客户配置
export function getCallback(code) {
  return fetch({
    url:
      '/api/basedatasys/bdCallbackConfig/queryByQstCode?customerCode=' + code,
    method: 'get'
  })
}
