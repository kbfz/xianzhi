        ...
        <div class="app-container-left">
          <div class="filter-container">
            <el-input @keyup.enter.native="handleFilter"
                      ...
                      class="filter-item"
                      placeholder="关区名称"
                      v-model="query.districtCode"> </el-input>
            <el-input @keyup.enter.native="handleFilter"
                      style="width: 200px;"
                      class="filter-item"
                      placeholder="关区编码"
                      v-model="query.districtName"> </el-input>
          ...
          <el-dialog :title="textMap[dialogStatus]"
            ...
            <el-form :model="form"
                     ...
                     :inline="true"
                     class="formLeft">
              <el-form-item label="关区城市"
                            prop="districtCode">
                <el-input v-model="form.districtName"
                          placeholder="请输入关区城市"></el-input>
              </el-form-item>
              <el-form-item label="关区编码"
                            prop="districtName">
                <el-input v-model="form.districtCode"
                          placeholder="请输入关区编码"></el-input>
              </el-form-item>
            </el-form>
            <div slot="footer"
                 class="dialog-footer">
...
import {
  ...
  delObj,
  putObj
} from "api/baseDataSys/CustomsCode/index";
...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      let param = {
        districtCode: $.trim(this.query.districtCode),
        districtName: $.trim(this.query.districtName),
        ...this.listQuery
      }
