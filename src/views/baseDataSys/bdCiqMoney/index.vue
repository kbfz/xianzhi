      ...
      <el-col :span="18">
        <div class="app-container-left">
          <div class="filter-container">
            ...
            <el-button class="filter-item"
                       v-if="bdCiqMoneyManager_btn_add"
          ...
          <el-dialog :title="textMap[dialogStatus]"
            ...
            <el-form :model="form"
                     ...
                     ref="form"
                     label-width="120px">
              <el-form-item label="币值编码"
                            prop="code">
                <el-input v-model="form.code"
                          placeholder="请输入币值编码"></el-input>
              </el-form-item>
...
import {
  ...
  delObj,
  putObj
} from "api/baseDataSys/bdCiqMoney/index";
...
export default {
  ...
  data () {
    return {
      ...
      dialogStatus: "",
      bdCiqMoneyManager_btn_edit: false,
      bdCiqMoneyManager_btn_del: false,
      bdCiqMoneyManager_btn_add: false,
      textMap: {
        update: "编辑",
        create: "创建"
      },
  ...
  created () {
    this.getList();
    this.bdCiqMoneyManager_btn_edit = this.elements[
      "bdCiqMoneyManager:btn_edit"
    ];
    this.bdCiqMoneyManager_btn_del = this.elements["bdCiqMoneyManager:btn_del"];
    this.bdCiqMoneyManager_btn_add = this.elements["bdCiqMoneyManager:btn_add"];
  },
  computed: {
