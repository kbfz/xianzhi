      ...
      <el-col :span="18">
        <div class="app-container-left">
          <div class="filter-container">
            ...
            <el-button class="filter-item"
                       v-if="bdCiqTransportManager_btn_add"
...
import {
  ...
  delObj,
  putObj
} from "api/baseDataSys/bdCiqTransport/index";
...
export default {
  ...
  data () {
    return {
      ...
      dialogStatus: "",
      bdCiqTransportManager_btn_edit: false,
      bdCiqTransportManager_btn_del: false,
      bdCiqTransportManager_btn_add: false,
      textMap: {
        update: "编辑",
        create: "创建"
      },
  ...
  created () {
    this.getList();
    this.bdCiqTransportManager_btn_edit = this.elements[
      "bdCiqTransportManager:btn_edit"
    ];
    this.bdCiqTransportManager_btn_del = this.elements[
      "bdCiqTransportManager:btn_del"
    ];
    this.bdCiqTransportManager_btn_add = this.elements[
      "bdCiqTransportManager:btn_add"
    ];
  },
  computed: {
