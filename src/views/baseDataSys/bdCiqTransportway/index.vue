        ...
        <div class="app-container-left">
          <div class="filter-container">
            <el-input @keyup.enter.native="handleFilter"
                      ...
                      class="filter-item"
                      placeholder="名称"
                      v-model="query.itemname"> </el-input>
            ...
            <el-button class="filter-item"
                       v-if="bdCiqTransportwayManager_btn_add"
...
import {
  ...
  delObj,
  putObj
} from "api/baseDataSys/bdCiqTransportway/index";
...
export default {
  ...
  data () {
    return {
      ...
      dialogStatus: "",
      bdCiqTransportwayManager_btn_edit: false,
      bdCiqTransportwayManager_btn_del: false,
      bdCiqTransportwayManager_btn_add: false,
      textMap: {
        update: "编辑",
        create: "创建"
      },
  ...
  created () {
    this.getList();
    this.bdCiqTransportwayManager_btn_edit = this.elements[
      "bdCiqTransportwayManager:btn_edit"
    ];
    this.bdCiqTransportwayManager_btn_del = this.elements[
      "bdCiqTransportwayManager:btn_del"
    ];
    this.bdCiqTransportwayManager_btn_add = this.elements[
      "bdCiqTransportwayManager:btn_add"
    ];
  },
  computed: {
  ...
  methods: {
    ...
    getList () {
      ...
      let param = {
        itemname: $.trim(this.query.itemname),
        ...this.listQuery
      }
