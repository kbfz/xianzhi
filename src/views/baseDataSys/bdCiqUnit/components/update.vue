  ...
  <div> 
   ...
   <el-form :model="form" :rules="rules" ref="form" label-width="120px"> 
    <el-form-item label="单位编码" prop="code"> 
     <el-input v-model="form.code" placeholder="请输入单位编码" :disabled="formEdit"></el-input> 
    </el-form-item> 
    <el-form-item label="单位名称" prop="name"> 
     <el-input v-model="form.name" placeholder="请输入单位名称" :disabled="formEdit"></el-input> 
    </el-form-item> 
   </el-form> 
...
<script>
import { addObj, putObj } from "api/baseDataSys/bdCiqUnit/index";
