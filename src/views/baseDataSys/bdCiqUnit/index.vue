...
import {
  ...
  delObj,
  putObj
} from "api/baseDataSys/bdCiqUnit/index";
...
export default {
  ...
  data () {
    return {
      ...
      dialogStatus: "",
      bdCiqUnitManager_btn_edit: false,
      bdCiqUnitManager_btn_del: false,
      bdCiqUnitManager_btn_add: false,
      textMap: {
        update: "编辑",
        create: "创建"
      },
  ...
  created () {
    this.getList();
    this.bdCiqUnitManager_btn_edit = this.elements["bdCiqUnitManager:btn_edit"];
    this.bdCiqUnitManager_btn_del = this.elements["bdCiqUnitManager:btn_del"];
    this.bdCiqUnitManager_btn_add = this.elements["bdCiqUnitManager:btn_add"];
  },
  computed: {
