      ...
      <el-col :span="18">
        <div class="app-container-left">
          <div class="filter-container">
            ...
            <el-button class="filter-item"
                       v-if="bdCusMoneyManager_btn_add"
...
import {
  ...
  delObj,
  putObj
} from "api/baseDataSys/bdCusMoney/index";
...
export default {
  ...
  data () {
    return {
      ...
      dialogStatus: "",
      bdCusMoneyManager_btn_edit: false,
      bdCusMoneyManager_btn_del: false,
      bdCusMoneyManager_btn_add: false,
      textMap: {
        update: "编辑",
        create: "创建"
      },
  ...
  created () {
    this.getList();
    this.bdCusMoneyManager_btn_edit = this.elements[
      "bdCusMoneyManager:btn_edit"
    ];
    this.bdCusMoneyManager_btn_del = this.elements["bdCusMoneyManager:btn_del"];
    this.bdCusMoneyManager_btn_add = this.elements["bdCusMoneyManager:btn_add"];
  },
  computed: {
