      ...
      <el-col :span="18">
        <div class="app-container-left">
          <div class="filter-container">
            ...
            <el-button class="filter-item"
                       v-if="bdCusPackageManager_btn_add"
...
import {
  ...
  delObj,
  putObj
} from "api/baseDataSys/bdCusPackage/index";
...
export default {
  ...
  data () {
    return {
      ...
      dialogStatus: "",
      bdCusPackageManager_btn_edit: false,
      bdCusPackageManager_btn_del: false,
      bdCusPackageManager_btn_add: false,
      textMap: {
        update: "编辑",
        create: "创建"
      },
  ...
  created () {
    this.getList();
    this.bdCusPackageManager_btn_edit = this.elements[
      "bdCusPackageManager:btn_edit"
    ];
    this.bdCusPackageManager_btn_del = this.elements[
      "bdCusPackageManager:btn_del"
    ];
    this.bdCusPackageManager_btn_add = this.elements[
      "bdCusPackageManager:btn_add"
    ];
  },
  computed: {
