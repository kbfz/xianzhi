...
import {
  ...
  delObj,
  putObj
} from "api/baseDataSys/bdCusPort/index";
...
export default {
  ...
  data () {
    return {
      ...
      dialogStatus: "",
      bdCusPortManager_btn_edit: false,
      bdCusPortManager_btn_del: false,
      bdCusPortManager_btn_add: true,
      textMap: {
        update: "编辑",
        create: "创建"
      },
  ...
  created () {
    this.getList();
    this.bdCusPortManager_btn_edit = this.elements["bdCusPortManager:btn_edit"];
    this.bdCusPortManager_btn_del = this.elements["bdCusPortManager:btn_del"];
    this.bdCusPortManager_btn_add = this.elements["bdCusPortManager:btn_add"];
  },
  computed: {
