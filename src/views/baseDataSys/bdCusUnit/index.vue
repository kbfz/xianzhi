...
import {
  ...
  delObj,
  putObj
} from "api/baseDataSys/bdCusUnit/index";
...
export default {
  ...
  data () {
    return {
      ...
      dialogStatus: "",
      bdCusUnitManager_btn_edit: false,
      bdCusUnitManager_btn_del: false,
      bdCusUnitManager_btn_add: false,
      textMap: {
        update: "编辑",
        create: "创建"
      },
  ...
  created () {
    this.getList();
    this.bdCusUnitManager_btn_edit = this.elements["bdCusUnitManager:btn_edit"];
    this.bdCusUnitManager_btn_del = this.elements["bdCusUnitManager:btn_del"];
    this.bdCusUnitManager_btn_add = this.elements["bdCusUnitManager:btn_add"];
  },
  computed: {
