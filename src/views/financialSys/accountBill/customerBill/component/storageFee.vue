  ...
  <div>
             <div class="hint-content">
                 ...
                 <div class="hint-list">
                     ...
                     <span> | </span>
                     <span>仓储费用明细：{{billForm.storageFee}}（不含税）</span>
                 </div>
             </div>
            <el-form
                :model="query"
                ...
                <!-- <el-form-item>
                    <el-button type="primary" @click="searchEvent">全部导出</el-button>
                </el-form-item> -->
            </el-form>
            <el-table 
                :data="tableList"
                ...
                :max-height="tableHeight"
                 style="width:682px"
                ref="table">
                <el-table-column label="总费用（不含税）" prop="totalPrice" align="center" show-overflow-tooltip width="150px"/>
                ...
                <el-table-column label="托数" prop="quantity" align="center" show-overflow-tooltip width="130px"/>
                <el-table-column label="单价" prop="price" align="center" show-overflow-tooltip width="120px"/>
            </el-table>   
