      ...
      <el-col :span="24">
        <div class="app-container-left">
          <div class="filter-container">
            ...
            <el-input v-model="query.expressNo" placeholder="物流单号" clearable></el-input>
            <el-input v-model="query.returnExpressNo" placeholder="退回物流单号" clearable></el-input>
            ...
            >
              ...
              <el-table-column min-width="140px" align="center" label="物流单号" prop='expressNo'   show-overflow-tooltip/>
              <el-table-column min-width="140px" align="center" label="退回物流单号" prop='returnExpressNo' show-overflow-tooltip/>
              <el-table-column min-width="100px" align="center" label="退回地址" prop='returnAddress' show-overflow-tooltip/>
              <el-table-column min-width="100px" align="center" label="重量" prop='weight' show-overflow-tooltip/>
              <el-table-column min-width="100px" align="center" label="物流费" prop='postFee' show-overflow-tooltip/>
          ...
          >
            <el-form :model="form" :rules="rules" ref="form" label-width="90px" :inline="true">
              ...
              <el-form-item label="客户编号" prop="customerCode" class="marginListAdd">
               ...
               <el-form-item label="物流单号" prop="expressNo" class="marginListAdd">
                <el-input v-model="form.expressNo" placeholder="物流单号" style="width:200px"></el-input>
              </el-form-item>
              <el-form-item label="退回物流单号" prop="returnExpressNo" class="marginListAdd">
                <el-input v-model="form.returnExpressNo" placeholder="退回物流单号" style="width:200px"></el-input>
              </el-form-item>
              <el-form-item label="退回地址" prop="returnAddress" class="marginListAdd">
                <el-input v-model="form.returnAddress" placeholder="退回地址" style="width:200px"></el-input>
              </el-form-item>
              ...
              <el-form-item label="物流费" prop="postFee" class="marginListAdd">
                <el-input v-model="form.postFee" placeholder="物流费" style="width:200px"></el-input>
              </el-form-item>
            </el-form>
...
export default {
  ...
  methods: {
    getList() {
      ...
      getPageList_R2F(param).then((response) => {
    ...
    getFile(event) {
     ...
     exportSave() {
      ...
      this.$http
        .post(
          "/api/ordersys/customerFinanceBillReturn/importReturn",
          formData,
          config
        )
        .then((res) => {
    ...
    closeMaterial() {
      ...
      this.form = {month:'',customerCode:'',customerName:''};
      this.id = ''
    },
    monthChange(val){
    ...
    editEvent(){
      ...
      if(this.form.expressNo ==''){ return  this.$message({ message: '物流单号不能为空',type: 'warning'})}
      if(this.form.returnExpressNo ==''){ return  this.$message({ message: '退回物流单号不能为空',type: 'warning'})}
      if(this.form.returnAddress ==''){ return  this.$message({ message: '退回地址不能为空',type: 'warning'})}
      if(this.form.weight ==''){ return  this.$message({ message: '重量不能为空',type: 'warning'})}
      if(this.form.postFee ==''){ return  this.$message({ message: '物流费不能为空',type: 'warning'})}
      let param = JSON.parse(JSON.stringify(this.form));
      param.id = this.id
      editBillReturn(this.id,param).then(res =>{
        if(res.status == 200){
           this.$notify({
              title: '成功',
              message: '保存成功',
    ...
    addEvent(){
      ...
      if(!this.form.weight){ return  this.$message({ message: '重量不能为空',type: 'warning'})}
      if(!this.form.postFee){ return  this.$message({ message: '物流费不能为空',type: 'warning'})}
       addBillReturn(this.form).then(res =>{
          if(res.status == 200){
            this.$notify({
                title: '成功',
                message: '添加成功',
