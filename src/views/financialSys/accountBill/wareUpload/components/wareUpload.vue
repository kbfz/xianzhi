        ...
        <div class="app-container-left uploadDialog">
          <div class="filter-container">
            ...
            >
              ...
              <el-table-column min-width="100px" align="center" label="托数" show-overflow-tooltip>
                <template scope="scope">
          ...
          >
            <el-form :model="form" :rules="rules" ref="form" label-width="90px" :inline="true">
              ...
              <div style="position: relative;float: left">
                ...
                <el-form-item label="托数" class="marginListAdd">
                  <el-input v-model="form.quantity" placeholder="托数" style="width:200px"></el-input>
                </el-form-item>
              </div>
              <!-- <div style="position: relative;float: left">
                <span class="xhText" style="left: 42px">*</span>
              ...
              <div style="position: relative;float: left">
                ...
                <el-form-item label="总价" class="marginListAdd">
                  <el-input v-model="form.totalPrice" placeholder="总价" style="width:200px"></el-input>
                </el-form-item>
              </div> -->
            </el-form>
...
import { getStorageObj } from "@/api/financialSys/customerBill";
import { wareAdd,wareGet,wareUpdate,wareDel } from "api/financialSys/wareupload/index";
...
export default {
  ...
  methods: {
    getList() {
      ...
      getStorageObj(param).then((response) => {
    ...
    updateSubmit() {
      ...
      this.$confirm("确定要保存吗", "提示", {
        ...
        wareUpdate(obj.id, obj).then((res) => {
          if (res.rel) {
            this.$notify({
              title: "成功",
              message: "保存成功",
    ...
    getFile(event) {
     ...
     exportSave(event) {
      ...
      this.$http
        .post(
          "/api/ordersys/customerFinanceBillWarehouseFee/importWarehouseFee",
          formData,
          config
        )
        .then((res) => {
