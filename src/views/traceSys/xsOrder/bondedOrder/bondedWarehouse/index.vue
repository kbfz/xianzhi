        ...
        <div class="app-container-left">
         ...
         <el-option v-for="item in selectWareHouse" :key="item.value" :label="item.label" :value="item.value"></el-option>
            ...
            <el-select placeholder="请选择客户名称"
                       ...
                       popper-class="optionsContent"
                       filterable>
              <el-option v-for="item in selectCustomCode"
                         :key="item.value"
                         :lable="item.label"
                         :value="item.label"></el-option>
            </el-select>
      ...
      <template scope="scope">
        <span style="cursor: pointer;">{{scope.row.declaration_time}}</span>
            ...
            <el-table-column min-width="260"
                             ...
                             show-overflow-tooltip>
              <template scope="scope">
                <el-button type="success" class="btn" @click="dandelOrder(scope.row)">取消订单</el-button>
                <el-button type="primary" class="btn" @click="normalOrder(scope.row)">标记为处理完成</el-button>
              </template>
            </el-table-column>
          </el-table>
